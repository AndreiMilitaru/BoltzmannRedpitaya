...
# module references:
# mux_2, low_pass_v2, axis_red_pitaya_dac, dac_out_switch, axis_red_pitaya_adc
...
proc create_hier_cell_dac { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 15 -to 0 In6_DI
  create_bd_pin -dir I -from 0 -to 0 In7_DI
...
CONFIG.USE_RESET {false} \
  ...
  # Create port connections
  connect_bd_net -net adc_adc_a [get_bd_pins data_o] [get_bd_pins adc/adc_a]
  connect_bd_net -net adc_adc_b [get_bd_pins adc_b] [get_bd_pins adc/adc_b]
...
CONFIG.DOUT_WIDTH {3} \
  ...
  connect_bd_net -net DAC_switch_2_Dout [get_bd_pins Dout] [get_bd_pins DAC_switch_2/Dout]
...
CONFIG.DOUT_WIDTH {14} \
  ...
  connect_bd_net -net GPIO_gpio_io_o3 [get_bd_pins alpha_i] [get_bd_pins low_pass_v2_0/alpha_i]
  connect_bd_net -net c_addsub_0_S [get_bd_pins c_addsub_0/S] [get_bd_pins mult_gen_0/A]
  connect_bd_net -net gain_i_Dout [get_bd_pins Dout3] [get_bd_pins gain_i/Dout] [get_bd_pins mult_gen_0/B]
  ...
  connect_bd_net -net mult_gen_0_P [get_bd_pins mult_gen_0/P] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  ...
  connect_bd_net -net sampling_reducer_0_data_o [get_bd_pins data_i] [get_bd_pins low_pass_v2_0/data_i]
...
# Hierarchical cell: LED_control
proc create_hier_cell_LED_control { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_LED_control() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -from 7 -to 0 out_o
...
CONFIG.DOUT_WIDTH {8} \
  ...
  # Create port connections
  connect_bd_net -net Din1_1 [get_bd_pins Din1] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins mux_2_0/a_in]
  connect_bd_net -net mux_2_0_out_o [get_bd_pins mux_2_0/out_o] [get_bd_pins xlslice_5/Din]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins mux_2_0/b_in] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins mux_2_0/sel_i] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins out_o] [get_bd_pins xlslice_5/Dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: LED_control
  create_hier_cell_LED_control [current_bd_instance .] LED_control
...
CONFIG.DOUT_WIDTH {14} \
  ...
  connect_bd_net -net In6_DI_1 [get_bd_pins adc_in/adc_b] [get_bd_pins dac/In6_DI]
  connect_bd_net -net Net [get_bd_pins GPIO/gpio_io_o1] [get_bd_pins LED_control/Din1] [get_bd_pins Switch_control/Din]
  ...
  connect_bd_net -net mux_2_0_out_o [get_bd_ports led_o] [get_bd_pins LED_control/out_o]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins LED_control/Din] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins dac/In7_DI] [get_bd_pins dac/Reset_RBI] [get_bd_pins xlconstant_0/dout]
