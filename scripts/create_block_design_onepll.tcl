...
CONFIG.N_OUT {14} \
  ...
  create_hier_cell_phase_det [current_bd_instance .] phase_det
...
CONFIG.C_SIZE {2} \
  ...
  create_hier_cell_wave_gen [current_bd_instance .] wave_gen
...
CONFIG.DOUT_WIDTH {14} \
  ...
  connect_bd_net -net In1_DI_1 [get_bd_pins dac/In1_DI] [get_bd_pins xlslice_7/Dout]
  connect_bd_net -net In3_DI_1 [get_bd_pins dac/In3_DI] [get_bd_pins xlslice_8/Dout]
  connect_bd_net -net Ref_DI_1 [get_bd_pins adc/adc_a] [get_bd_pins phase_det/Ref_DI]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o1 [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_5/Din] [get_bd_pins xlslice_6/Din]
